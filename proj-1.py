...
date=Label(win,text=f"{dt}",font=('arial',30,'bold'),bg='pink')
...
def main_screen():
    ...
    btn_fp=Button(frm,command=forgotpass,width=17,text="forgot password",font=('arial',20,'bold'),bd=5)
...
def welcome_screen():
    ...
    def details():
        ...
        lbl_opendate.place(relx=.2,rely=.1)

        lbl_bal=Label(ifrm,text=f"Bal:{tup[1]}",font=('arial',15,'bold'),bg='white') 
        lbl_bal.place(relx=.2,rely=.17)

        lbl_gender=Label(ifrm,text=f"Gender:{tup[2]}",font=('arial',15,'bold'),bg='white') 
        lbl_gender.place(relx=.2,rely=.24)

        lbl_email=Label(ifrm,text=f"Open Date:{tup[3]}",font=('arial',15,'bold'),bg='white') 
        lbl_email.place(relx=.2,rely=.31)

        lbl_mob=Label(ifrm,text=f"Open Date:{tup[0]}",font=('arial',15,'bold'),bg='white') 
        lbl_mob.place(relx=.2,rely=.38)
    ...
    def deposit():
        ...
        e_amt=Entry(ifrm,font=('arial',20,'bold'),bd=5,show='')
    ...
    def transfer():
        ...
        e_to=Entry(ifrm,font=('arial',20,'bold'),bd=5,show='')
